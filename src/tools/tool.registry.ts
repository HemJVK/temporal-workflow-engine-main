...
import { TwilioTool } from './twilio.tool';
...
const registry: Partial<Record<NodeType, IWorkflowTool>> = {
  ...
  send_sms_twilio: new TwilioTool(),
  make_notification_call_twilio: new TwilioTool(),
  make_conversation_call_twilio: new TwilioTool(),
  send_email_sendgrid: new SendGridTool(),
